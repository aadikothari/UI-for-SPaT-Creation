...
*/
typedef OSINT16 ASN1T_AddGrpB_Elevation;

EXTERN int asn1PE_AddGrpB_Elevation (OSCTXT* pctxt, ASN1T_AddGrpB_Elevation value);

EXTERN int asn1PD_AddGrpB_Elevation (OSCTXT* pctxt, ASN1T_AddGrpB_Elevation* pvalue);

EXTERN int XmlEnc_AddGrpB_Elevation (OSCTXT* pctxt, 
   ASN1T_AddGrpB_Elevation value, const OSUTF8CHAR* elemName, 
   const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_AddGrpB_Elevation (OSCTXT* pctxt, 
   ASN1T_AddGrpB_Elevation* pvalue);

EXTERN int asn1JsonEnc_AddGrpB_Elevation (OSCTXT *pctxt, ASN1T_AddGrpB_Elevation *pvalue);

EXTERN int asn1JsonDec_AddGrpB_Elevation (OSCTXT *pctxt, ASN1T_AddGrpB_Elevation *pvalue);

EXTERN int asn1PrtToStrm_AddGrpB_Elevation (OSCTXT *pctxt, 
   const char* name, const ASN1T_AddGrpB_Elevation* pvalue);

EXTERN ASN1T_AddGrpB_Elevation* new_ASN1T_AddGrpB_Elevation (ASN1CType& ccobj)
   ;
...
struct EXTERN ASN1T_Position3D_addGrpB {
   ...
   ASN1T_AddGrpB_Elevation elevation;
...
*/
typedef OSUINT8 ASN1T_AddGrpB_Angle;

class EXTERN ASN1C_AddGrpB_Angle :
public ASN1CType
{
protected:
   ASN1T_AddGrpB_Angle& msgData;
public:
   /**
    * Control class: ASN1C_AddGrpB_Angle
    * Data class:    ASN1T_AddGrpB_Angle
    *
    ...
    */
   ASN1C_AddGrpB_Angle (ASN1T_AddGrpB_Angle& data);

   /**
    * Control class: ASN1C_AddGrpB_Angle<br/>
    * Data class: ASN1T_AddGrpB_Angle<br/>
    *
    ...
    */
   ASN1C_AddGrpB_Angle (OSRTMessageBufferIF& msgBuf, ASN1T_AddGrpB_Angle& data);

   virtual ~ASN1C_AddGrpB_Angle () {}
    ...
    *
    * @return Reference to a mutable instance of data class ASN1T_AddGrpB_Angle.
    */
   inline ASN1T_AddGrpB_Angle& getData () { return msgData; }

   /**
    * Data class: ASN1T_AddGrpB_Angle<br/>
    * Gets a non-mutable instance of the data class.
    *
    * @return Reference to a non-mutable instance of data class ASN1T_AddGrpB_Angle.
    */
   inline const ASN1T_AddGrpB_Angle& getData () const { return msgData; }
...
private:
   ASN1C_AddGrpB_Angle& operator= (const ASN1C_AddGrpB_Angle&) {return *this;}
} ;

EXTERN int asn1PE_AddGrpB_Angle (OSCTXT* pctxt, ASN1T_AddGrpB_Angle value);

EXTERN int asn1PD_AddGrpB_Angle (OSCTXT* pctxt, ASN1T_AddGrpB_Angle* pvalue);

EXTERN int XmlEnc_AddGrpB_Angle (OSCTXT* pctxt, ASN1T_AddGrpB_Angle value, 
   const OSUTF8CHAR* elemName, const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_AddGrpB_Angle (OSCTXT* pctxt, ASN1T_AddGrpB_Angle* pvalue);

EXTERN int asn1JsonEnc_AddGrpB_Angle (OSCTXT *pctxt, ASN1T_AddGrpB_Angle *pvalue);

EXTERN int asn1JsonDec_AddGrpB_Angle (OSCTXT *pctxt, ASN1T_AddGrpB_Angle *pvalue);

EXTERN int asn1PrtToStrm_AddGrpB_Angle (OSCTXT *pctxt, 
   const char* name, const ASN1T_AddGrpB_Angle* pvalue);

EXTERN ASN1T_AddGrpB_Angle* new_ASN1T_AddGrpB_Angle (ASN1CType& ccobj);
...
*/
typedef OSUINT8 ASN1T_AddGrpB_MsgCount;

class EXTERN ASN1C_AddGrpB_MsgCount :
public ASN1CType
{
protected:
   ASN1T_AddGrpB_MsgCount& msgData;
public:
   /**
    * Control class: ASN1C_AddGrpB_MsgCount
    * Data class:    ASN1T_AddGrpB_MsgCount
    *
    * Constructs an instance of the control class given an instance of
    * the data class.
    *
    ...
    * @param data    A reference to an instance of the data class.
    */
   ASN1C_AddGrpB_MsgCount (ASN1T_AddGrpB_MsgCount& data);

   /**
    * Control class: ASN1C_AddGrpB_MsgCount<br/>
    * Data class: ASN1T_AddGrpB_MsgCount<br/>
    *
    * Constructs an instance of the control class given an instance
    * of an encode or decode buffer and an instance of
    * the data class.
    ...
    * @param data   Reference to an instance of the data class.
    */
   ASN1C_AddGrpB_MsgCount (OSRTMessageBufferIF& msgBuf
      , ASN1T_AddGrpB_MsgCount& data);

   virtual ~ASN1C_AddGrpB_MsgCount () {}
    ...
    * Gets a mutable instance of the data class.
    *
    * @return Reference to a mutable instance of data class ASN1T_AddGrpB_MsgCount.
    */
   inline ASN1T_AddGrpB_MsgCount& getData () { return msgData; }

   /**
    * Data class: ASN1T_AddGrpB_MsgCount<br/>
    * Gets a non-mutable instance of the data class.
    *
    * @return Reference to a non-mutable instance of data class ASN1T_AddGrpB_MsgCount.
    */
   inline const ASN1T_AddGrpB_MsgCount& getData () const { return msgData; }
   ...
   int setPrintStream (rtxPrintCallback strmCallback, void* pStrmInfo);
private:
   ASN1C_AddGrpB_MsgCount& operator= (const ASN1C_AddGrpB_MsgCount&) {return *this;}
} ;

EXTERN int asn1PE_AddGrpB_MsgCount (OSCTXT* pctxt, ASN1T_AddGrpB_MsgCount value);

EXTERN int asn1PD_AddGrpB_MsgCount (OSCTXT* pctxt, ASN1T_AddGrpB_MsgCount* pvalue);

EXTERN int XmlEnc_AddGrpB_MsgCount (OSCTXT* pctxt, 
   ASN1T_AddGrpB_MsgCount value, const OSUTF8CHAR* elemName, 
   const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_AddGrpB_MsgCount (OSCTXT* pctxt, 
   ASN1T_AddGrpB_MsgCount* pvalue);

EXTERN int asn1JsonEnc_AddGrpB_MsgCount (OSCTXT *pctxt, ASN1T_AddGrpB_MsgCount *pvalue);

EXTERN int asn1JsonDec_AddGrpB_MsgCount (OSCTXT *pctxt, ASN1T_AddGrpB_MsgCount *pvalue);

EXTERN int asn1PrtToStrm_AddGrpB_MsgCount (OSCTXT *pctxt, 
   const char* name, const ASN1T_AddGrpB_MsgCount* pvalue);

EXTERN ASN1T_AddGrpB_MsgCount* new_ASN1T_AddGrpB_MsgCount (ASN1CType& ccobj);
...
*/
struct EXTERN ASN1T_AddGrpB_TimeMark : public ASN1TPDU {
   ASN1T_Year year;
   ASN1T_Month month;
   ASN1T_Day day;
...
class EXTERN ASN1C_AddGrpB_TimeMark :
public ASN1CType
{
protected:
   ASN1T_AddGrpB_TimeMark& msgData;
public:
   /**
    * Control class: ASN1C_AddGrpB_TimeMark
    * Data class:    ASN1T_AddGrpB_TimeMark
    *
    * Constructs an instance of the control class given an instance of
    * the data class.
    *
    ...
    * @param data    A reference to an instance of the data class.
    */
   ASN1C_AddGrpB_TimeMark (ASN1T_AddGrpB_TimeMark& data);

   /**
    * Control class: ASN1C_AddGrpB_TimeMark<br/>
    * Data class: ASN1T_AddGrpB_TimeMark<br/>
    *
    * Constructs an instance of the control class given an instance
    * of an encode or decode buffer and an instance of
    * the data class.
    ...
    * @param data   Reference to an instance of the data class.
    */
   ASN1C_AddGrpB_TimeMark (OSRTMessageBufferIF& msgBuf
      , ASN1T_AddGrpB_TimeMark& data);

   virtual ~ASN1C_AddGrpB_TimeMark () {}
    ...
    * Gets a mutable instance of the data class.
    *
    * @return Reference to a mutable instance of data class ASN1T_AddGrpB_TimeMark.
    */
   inline ASN1T_AddGrpB_TimeMark& getData () { return msgData; }

   /**
    * Data class: ASN1T_AddGrpB_TimeMark<br/>
    * Gets a non-mutable instance of the data class.
    *
    * @return Reference to a non-mutable instance of data class ASN1T_AddGrpB_TimeMark.
    */
   inline const ASN1T_AddGrpB_TimeMark& getData () const { return msgData; }
   ...
   int setPrintStream (rtxPrintCallback strmCallback, void* pStrmInfo);
private:
   ASN1C_AddGrpB_TimeMark& operator= (const ASN1C_AddGrpB_TimeMark&) {return *this;}
} ;

EXTERN int asn1PE_AddGrpB_TimeMark (OSCTXT* pctxt, ASN1T_AddGrpB_TimeMark* pvalue);

EXTERN int asn1PD_AddGrpB_TimeMark (OSCTXT* pctxt, ASN1T_AddGrpB_TimeMark* pvalue);

EXTERN int XmlEnc_AddGrpB_TimeMark (OSCTXT* pctxt, 
   ASN1T_AddGrpB_TimeMark* pvalue, const OSUTF8CHAR* elemName, 
   const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_AddGrpB_TimeMark (OSCTXT* pctxt, 
   ASN1T_AddGrpB_TimeMark* pvalue);

EXTERN int asn1JsonEnc_AddGrpB_TimeMark (OSCTXT *pctxt, ASN1T_AddGrpB_TimeMark *pvalue);

EXTERN int asn1JsonDec_AddGrpB_TimeMark (OSCTXT *pctxt, ASN1T_AddGrpB_TimeMark *pvalue);

EXTERN int asn1PrtToStrm_AddGrpB_TimeMark (OSCTXT *pctxt, 
   const char* name, const ASN1T_AddGrpB_TimeMark* pvalue);

EXTERN ASN1T_AddGrpB_TimeMark* new_ASN1T_AddGrpB_TimeMark (ASN1CType& ccobj);
